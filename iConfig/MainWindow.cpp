...
{
    if ((commandList.contains(Command::GetAudioInfo)) || (commandList.contains(Command::GetAudioGlobalParm))) {
        //    ui->toolBar->addSeparator();
        ...
        if ((commandList.contains(Command::GetAudioPortPatchbay)) || (commandList.contains(Command::GetAudioPatchbayParm))) {
...
void MainWindow::generateToolBar(GeneSysLib::CommandList commandList)
{
    ...
    if ((commandList.contains(Command::GetInfoList)) || (commandList.contains(Command::GetInfo))) {
...
void MainWindow::queryCompleted(Screen screen, CommandQList)
{
    if (connected) {
        ...
        case PortFiltersScreen: {
            MIDIPortFiltersForm* filters = new MIDIPortFiltersForm(comm, currentDevice);
        ...
        case ChannelRemapScreen: {
            MIDIChannelRemapForm* remap = new MIDIChannelRemapForm(comm, currentDevice);
        ...
        case CCFiltersScreen: {
            auto* const ccFilterForm = new MIDIControllerFilterForm(comm, currentDevice);
...
void MainWindow::updateFileMenu()
{
    ...
    if ((currentDevice) || (!connected)) {
        ...
        savableNew = ((deviceID.pid() == (Byte)(DevicePID::iConnect2Plus)) || (deviceID.pid() == (Byte)(DevicePID::iConnect4Plus)) || (deviceID.pid() == (Byte)(DevicePID::iConnect4Audio)) || (deviceID.pid() == (Byte)(DevicePID::MIO2)) || (deviceID.pid() == (Byte)(DevicePID::MIO4)) || (deviceID.pid() == (Byte)(DevicePID::MIO10)) || (deviceID.pid() == (Byte)(DevicePID::PlayAudio12)) ||
...
void MainWindow::updateDeviceMenu()
{
    ...
    if ((currentDevice) || (!connected)) {
        if (currentDevice->contains<SaveRestoreList>()) {
            ...
            commitToFlashSupported = saveRestoreListData.contains(SaveRestoreID::SaveToFlash);
            restoreFromFlashSupported = saveRestoreListData.contains(SaveRestoreID::RestoreFromFlash);
            restoreFactorySupported = saveRestoreListData.contains(SaveRestoreID::FactoryDefault);
        }
...
void MainWindow::createActions()
{
    ...
    if (!devInfoAction) {
        ...
        portRoutingAction = new QAction(MIDIPortRoutingForm::DefaultWindowTitle, this);
        ...
        portFilterAction = new QAction(MIDIPortFiltersForm::DefaultWindowTitle, this);
        ...
        channelRemapAction = new QAction(MIDIChannelRemapForm::DefaultWindowTitle, this);
        ...
        ccFilterAction = new QAction(MIDIControllerFilterForm::DefaultWindowTitle, this);
        ...
        ccRemapAction = new QAction(MIDIControllerRemapForm::DefaultWindowTitle, this);
        ...
        audioPatchbayAction = new QAction(AudioPatchbayForm::DefaultWindowTitle, this);
        ...
        audioControlAction = new QAction(AudioControlWidget::DefaultWindowTitle, this);
        ...
        audioMixerAction = new QAction(MixerWidget::DefaultWindowTitle, this);
...
{
    QString aboutString = "<H1>" + QCoreApplication::applicationName() + "</H1>" + "<center>"
                                                                                   "<table>"
                                                                                   "<tr>"
                                                                                   "   <th>Version:"
        + QCoreApplication::applicationVersion() + "</th>"
                                                   "</tr>"
                                                   "<tr/><tr>"
                                                   "<th>Copyright &#169;, iKingdom Corp. 2026</th>"
                                                   "</table>"
                                                   "</center>";
